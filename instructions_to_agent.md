...
- https://connect.craft.do/links/2xPCLTui75d/api/v1
...
Retrieve all documents accessible through this multi-document connection. Returns document IDs, titles, and deletion status for each document.
